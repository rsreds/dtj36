...
func on_drafted(parent_planet: PlanetData, planet_list: PlanetList) -> void:
	pass
...
## `parent_planet` is the planet with this effect.
## The `planet_list` PlanetList can be used for adjaceny effects etc.
func on_orbit(parent_planet: PlanetData, planet_list: PlanetList) -> void:
	pass
...
## `parent_planet` is the planet with this effect.
## The `planet_list` PlanetList can be used for adjaceny effects etc.
func on_trigger(parent_planet: PlanetData, planet_list: PlanetList) -> void:
	pass
